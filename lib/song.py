...
# Output the results
print(Song.count)  # Output the number of songs
print(Song.artists)  # Output all artists
print(Song.genres)  # Output all genres
print(Song.genre_count)  # Output genre count histogram
print(Song.artist_count)  # Output artist count histogram
